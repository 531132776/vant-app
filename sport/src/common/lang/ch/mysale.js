const ln = {
  ...
  RegisterChoAccount:'重购币注册',
  RegisterUSDT:'注册币注册',
  UnbindSubaccount: '解绑子账户',
  BindParentAccount: '绑定子账户',
  LeftRegion: '左区',
  RightRegion: '右区',
  RegisterParentAccountPage: {
    ...
    placeholder: {
      ...
      LoginPassword: '输入8-16位英文数字组合.....',
      ConfirmLoginPassword: '与登录密码相同......',
      SecurityCode: '输入8-16位英文数字组合.....',
    ...
    errors: {
      ...
      pwd: {
        required: '登录密码不能为空',
        enOrNumber: '登录密码只允许输入8-16位英文数字组合',
        size: '登录密码只允许输入8-16位英文数字组合',
        sameWithSafepwd: '登录密码和安全码不能相同',
        repeat: '两次登录密码输入不一致'
      },
      safepwd: {
        required: '安全码不能为空',
        enOrNumber: '安全码只允许输入8-16位英文数字组合',
        size: '安全码只允许输入8-16位英文数字组合',
        repeat: '两次安全码输入不一致'
      }
    },
    alert: '提示: 每次注册需要消耗10个注册币'
  },
  RegisterChirdAccountPage: {
    fields: {
      MemberAccount: '会员帐号',
      MemberName: '会员姓名',
      LoginPassword: '新密码',
